...
namespace LearnEXM.Foundation.JSONModelGenerator
{
  internal class Program
  {
    ...
    {
      Console.WriteLine("Your model is here: " + jsonFullFileName);
      Console.WriteLine("Copy the model to:");
      Console.WriteLine("\t1) {XConnect Webroot}\\App_Data\\App_Data\\Models");
      Console.WriteLine("\t2) {XConnect Webroot}\\App_Data\\jobs\\continuous\\IndexWorker\\App_Data\\Models\\");

      Console.WriteLine("\t3) if Sitecore 9.0 Update 2 or later");
      Console.WriteLine("\t\t{marketing automation operations Webroot}\\App_Data\\Models\\");
