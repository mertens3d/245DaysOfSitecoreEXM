...
using LearnEXMProject.Controllers;
...
namespace LearnEXM.Project.Website.Controllers
{
  public class SitecoreCinemaController : Controller
  {
    ...
    {
      var candidateInfoGenerator = new Feature.MockContactGenerator.MockContactGenerator();
